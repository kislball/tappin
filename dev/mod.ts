...
export const generateImportMap = (projects: Record<string, string>, { version, modules }: TappinJson) => {
  ...
  for (const module of modules) {
    map.import_map[`$tappin/${module}`] = `https://deno.land/x/tappin@${version}/${module}/mod.ts`
  }
